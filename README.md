...
5. **3개 탭:**
   - **시그니처 분석** — 3컬럼 (시간 lift / 별점 z 분포 / 사용자 작업장)
...
- **3 시그니처 통합 시각화:** 시간(라인) + 별점(히스토+막대) + 사용자(산점도+엣지)
...
| Yelp Open 비율 (시그니처 3 근거) | ~107:1 |

## 발표 핵심 메시지

> "본 연구 모델은 단순 사후 탐지가 아닙니다.
> 첫 90일 골든 타임 안에서 3개 시그니처를 실시간 추적하고,
