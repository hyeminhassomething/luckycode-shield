...
# Tabs
tab1, tab2, tab3 = st.tabs(['🔍 시그니처 분석', '📍 t-SNE 임베딩 이동', '📨 자동 검토 큐 (Slack)'])
...
with tab1:
    ...
    with col1:
        st.markdown("""
        <div class='sig-box'>
            <div class='sig-label'>시그니처 1 · 시간 차원</div>
    ...
    with col2:
        st.markdown("""
        <div class='sig-box'>
            <div class='sig-label red'>시그니처 2 · 별점 차원</div>
    ...
    with col3:
        st.markdown("""
        <div class='sig-box'>
            <div class='sig-label purple'>시그니처 3 · 사용자 차원</div>
...
<div class='slack-card'>
    ...
    <div class='section-title'>⚠️ 3개 시그니처 모두 임계값 초과</div>

    <div class='row'>🕐 <b>시그니처 1 (시간):</b></div>
    <div class='row'>&nbsp;&nbsp;└ 첫 90일+5점 lift <span class='red'>2.06×</span> (임계값 1.81×)</div>

    <div class='row'>⭐ <b>시그니처 2 (별점):</b></div>
    ...
    <div class='row'>👥 <b>시그니처 3 (사용자):</b></div>
